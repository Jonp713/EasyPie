...
function display_full_page_ad($ad_id){
	...
	echo("<div id = 'overlay'><button class = 'adxbutton btn btn-lg btn-default glyphicon glyphicon-remove-sign'></button><a href = 'http://www.hampshirezombledon.com' target ='_blank'><img src = 'images/bla/".$data['img']."' class = 'bla img-responsive col-xs-4 col-xs-offset-4'></a></div>");
