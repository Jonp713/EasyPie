...
function fixMask() {
    ...
    var strImage = '-webkit-radial-gradient(' + mouse.x + 'px ' + mouse.y + 'px,400px 300px, rgba(0, 0, 0, 1) 0%,rgba(0, 0, 0, 1) 1%, rgba(255, 255, 255, 0.7) 5%, rgba(255, 255, 255, 0.1) 40%, rgba(255, 255, 255, 0.0) 100%)';
    divPloatje.style.WebkitMaskImage = strImage;
	    ...
	    requestAnimationFrame(fixMask);
	    // Create string for -webkit-mask-image CSS attribute
	    var strImage = '-webkit-radial-gradient(' + mouse.x + 'px ' + mouse.y + 'px,400px 300px, rgba(0, 0, 0, 1) 0%,rgba(0, 0, 0, 1) 1%, rgba(255, 255, 255, 1) 5%, rgba(255, 255, 255, 0.3) 40%, rgba(255, 255, 255, 0.1) 100%)';
	    divPloatje.style.WebkitMaskImage = strImage;
...
$('.hoverer-icon').mousedown(function() {
	
	onHover = true;

});
$('#hole-comments-section').mousedown(function() {
	
	onHover = true;

});
$('#holeModal').mousedown(function() {
